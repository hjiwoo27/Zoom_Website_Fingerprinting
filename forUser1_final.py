...
# user 2에서 코드 실행
command_pi2 = f"python C:/Users/swu/Desktop/output/code/openZoom.py  {zoom_url}"  # user 2의 코드 경로
...
# user 2에서 코드 실행
command_pi2 = "python C:/Users/swu/Desktop/output/code/captureOnUser.sh"  # user 2의 코드 경로
ssh_connect_execute(pi2_ip, pi2_username, pi2_password, command_pi2)
